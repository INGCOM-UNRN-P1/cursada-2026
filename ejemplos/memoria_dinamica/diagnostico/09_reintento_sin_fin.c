 ...
 *
 *   gcc -std=c11 -g memoria_dinamica/diagnostico/09_reintento_sin_fin.c -o
 * /tmp/reintento nostromo run /tmp/reintento vasquez inject
 * memoria_dinamica/diagnostico/09_reintento_sin_fin.c--fail-malloc-at 1 vasquez
 * inject memoria_dinamica/diagnostico/09_reintento_sin_fin.c--fail-malloc-at 1
 * --cascade
 *
