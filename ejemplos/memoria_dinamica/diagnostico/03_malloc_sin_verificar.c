 ...
 *
 *   gcc -std=c11 -g memoria_dinamica/diagnostico/03_malloc_sin_verificar.c -o
 * /tmp/sin_verificar nostromo run /tmp/sin_verificar             # 16: sin
 * fallos, parece correcto vasquez inject
 * memoria_dinamica/diagnostico/03_malloc_sin_verificar.c--fail-malloc-at 1
 *
