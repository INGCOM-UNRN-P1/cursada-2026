 ...
 * EXPLICACION: Dividir por cero produce fallos de ejecucion o valores
 * especiales (inf/NaN). Se valida explícitamente que el divisor sea distinto de
 * cero antes de realizar la division.
 */
