 ...
 * EXPLICACION: En C, el desbordamiento de enteros con signo es Comportamiento Indefinido (UB).
 * Para evitarlo, se valida antes de operar si la suma superaria INT_MAX o seria menor que INT_MIN.
 */
