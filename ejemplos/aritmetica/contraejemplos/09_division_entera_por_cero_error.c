 ...
 *   gcc -std=c11 -g
 * aritmetica/contraejemplos/09_division_entera_por_cero_error.c -o /tmp/reparto
 ...
 *   hal check
 * aritmetica/contraejemplos/09_division_entera_por_cero_error.c--stdin "10 0"
 *   hal check
 * aritmetica/contraejemplos/09_division_entera_por_cero_error.c--stdin
 * "-2147483648 -1"
 *
...
{
    // BUG: no se valida que el divisor sea distinto de 0 ni el caso INT_MIN /
    // -1
