 ...
 * EXPLICACION: Dividir 1.0 / 0.0 en IEEE 754 genera inf (infinito) sin lanzar excepcion de runtime,
 * lo que propaga valores invalidos en los calculos subsiguientes sin ser detectado a tiempo.
 */
