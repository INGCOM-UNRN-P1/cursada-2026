 ...
 * REGLA GENERAL:
 *   - El valor 0 (entero 0, flotante 0.0, caracter '\0', puntero NULL) evalua como FALSO.
 *   - Cualquier valor DISTINTO DE CERO (enteros positivos/negativos como -1, chars, punteros validos) evalua como VERDADERO.
 * Desde C99, <stdbool.h> define 'bool', 'true' (1) y 'false' (0).
 */
...
int main(void) {
    ...
    if (negativo) {
        printf("  -1 evalua como VERDADERO (cualquier entero != 0 es verdadero).\n");
    }
